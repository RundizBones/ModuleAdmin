...
class DataTableJsTest extends \Rdb\Tests\BaseTestCase
{


    /**
     * @var \Rdb\Modules\RdbAdmin\Libraries\DataTablesJs
     */
    ...
    public function setup(): void
    {
        ...
        $this->DataTablesJs = new \Rdb\Modules\RdbAdmin\Libraries\DataTablesJs();
    }// setup
    ...
    public function testBuildSortOrdersFromInput()
    {
        ...
        $this->assertTrue(empty(Arrays::array_diff_assoc_recursive($assert, $buildResult)));
