...
<?php include dirname(__DIR__) . '/htmlHead_v.php'; ?> 
        <header class="rd-navbar">
            <button class="rd-sidebar-toggler" data-target=".rd-page-wrapper" title="<?php echo esc__('Toggle side bar menu'); ?>">
                <i class="fa-solid fa-bars fa-fw fontawesome-icon"></i> 
            ...
            <nav class="nav-right">
                <ul class="sm sm-rdta navbar">
                    <li id="rdba-languages-navbar"><a href="#" onclick="return false;"><i class="fa-solid fa-globe fa-fw fontawesome-icon"></i></a>
                        <ul id="rdba-languages-navbar-list">
                            <li><a><?php echo __('Loading &hellip;'); ?></a></li>
                        </ul>
                    </li>
                    <li id="rdba-notification-navbar"><a href="#" onclick="return false;"><i class="fa-solid fa-bell fa-fw fontawesome-icon"></i></a>
                        <ul id="rdba-notification-navbar-list">
                            <li><a><?php echo __('Loading &hellip;'); ?></a></li>
                        </ul>
                    </li>
                    <li id="rdba-user-navbar" class="user"><a href="#" onclick="return false;"><i class="fa-regular fa-circle-user fontawesome-icon rdba-user-icon"></i></a>
            ...
            <section class="rd-sidebar">
                <div class="rd-sidebar-inner">
                    <ul class="rd-sidebar-item-list sm sm-vertical sm-rdta">
                        <li><a href="#" onclick="return false;"><i class="sidebar-icon fa-solid fa-spinner fa-pulse fontawesome-icon"></i> <span class="rd-sidebar-menu-text"><?php echo __('Loading &hellip;'); ?></span></a></li>
                    </ul>
                    <ul class="rd-sidebar-item-list rd-sidebar-expand-collapse-controls">
                        <li>
                            <a data-target=".rd-page-wrapper" title="<?php echo esc__('Expane/collapse menu'); ?>">
                                <i class="sidebar-icon faicon fa-solid fa-chevron-left fa-fw fontawesome-icon" data-toggle-icon="fa-chevron-left fa-chevron-right"></i> 
