...
const {default: Paths} = await import(url.pathToFileURL(RDBDEV_APPDIR + '/app/RdbDev/Libraries/Paths.mjs'));
const {default: TextStyles} = await import(url.pathToFileURL(RDBDEV_APPDIR + "/app/RdbDev/Libraries/TextStyles.mjs"));
